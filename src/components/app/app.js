...
const DescriptionFirstSentence = (props) => {
  ...
  return (
    <div>
      <div>
        Learn something new and try it on this project does't mater if it makes
        looks ugly or useless at all in this project
      </div>
      <ul>
...
const DescriptionThirdSentence = () => {
  return <div>What i want to learn, next or ,learning</div>;
};
...
export default class App extends Component {
  ...
  componentDidMount = () => {
    ...
    this.dataService
      .getHtmlChanges()
      .then((x) => this.setState({ color: x.data.background_color }));
  ...
  render() {
    ...
    return (
      <Router>
        <Route path="/lifecycles" render={() => <LifeCycles />} />
        <Route path="/tech" render={() => <Tech />} />
        <div className="w-full">
          <Route
            path="/create"
            render={() => <AddPostForm addItem={this.dataService.addItem} />}
          />
          <Route
            path="/update/:id"
            render={({ match }) => {
              ...
              return (
                <UpdatePostForm id={id} addItem={this.dataService.addItem} />
              );
            }}
          />
          <Route
              ...
              <div style={{ backgroundColor: this.state.color }}>
                ...
                <Description addHeader={appDescriptionComponent}>
                  <DescriptionFirstSentence>
                    {{
                      headerText: "a lot of data is hard for user expierence",
                      textColor: "pink",
                    }}
                  </DescriptionFirstSentence>
                ...
                <div className="aligner">
                  <div className="w-1/2">
                    <div className="">
                      <AnyList
                        getData={this.dataService.getAllFeatures}
                        user={isUser}
                        feature="features"
                        headline="Features"
                      />
