...
export default class App extends Component {
    ...
    createExp = () => {
        ...
        return workArraySorted.map((wrk) => {
            ...
            return (
                <div key={Math.random()} className="flex-full work-exp border-t-2">                   
                            ...
                            <div className="w-1/2">
                                ...
                                <div className="w-full mt-1 pt-1 mt-3 mb-3">
                                    ...
                                    <div className="flex-col">
                                        {helpers.length > 1 ? helpers.map((helper) => <span key={Math.random()} className="skill-span bg-teal-500 mr-3 p-1"> {helper}</span>) : null}
                                    </div>
                                </div>
...
const ImageDispl = (props) => {
        ...
        if(props.image !== null) {
            ...
            return (
                <div className="portolio-image w-1/2 pt-2 pb-2">
